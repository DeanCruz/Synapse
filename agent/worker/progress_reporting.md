# Worker Agent — Progress Reporting Protocol
...
2. **After initial write, if you have dependencies** — Read all upstream dependency progress files (see the upstream dependencies module). Log what you found. If any upstream task failed or has `CRITICAL` deviations, adapt before proceeding.
