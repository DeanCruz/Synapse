...
- The `.synapse/` directory inside the target project is where Synapse stores project-scoped configuration and the `.synapse/knowledge/` graph. Projects should add `.synapse/` to their `.gitignore`.
